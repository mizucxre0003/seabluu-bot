...
def get_worksheet(title: str):
    ...
    try:
        ...
        # auto-create with header, if needed
...
# === Subscriptions (optional: left unchanged) ===
# Добавьте здесь свои scan_updates(), subscribe(), и т.д., если они есть в проекте.
# Я исхожу из того, что эти функции уже реализованы у вас и используются в webhook.py.
